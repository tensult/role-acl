...
var Permission = /** @class */ (function () {
    ...
    function Permission(grants, query) {
        ...
        var conditionalAttributes = utils_1.default.getUnionConditionalAttrsOfRoles(grants, query, query.context);
        this._.attributes = this.computePermittedAttributes(conditionalAttributes);
    }
    Permission.prototype.computePermittedAttributes = function (conditionalAttributes) {
        var _this = this;
        return conditionalAttributes.filter(function (conditionalAttributeSet) {
            return condtions_1.conditionEvaluator(conditionalAttributeSet.condition, _this._.context);
        }).map(function (conditionalAttributeSet) {
