...
var utils = {
    ...
    getUnionAttrsOfGrants: function (grants, query) {
        var allowedAttributes = grants.filter(function (grant) {
        ...
        }).reduce(function (allAttributes, attributes) {
    ...
    getUnionAttrsOfRoles: function (grants, query) {
        ...
        roles.sort(function (role1, role2) {
            ...
            if (grants[role].grants) {
                var roleAllowedAttributes = utils.getUnionAttrsOfGrants(grants[role].grants, query);
            ...
            if (grants[role].$extend) {
                Object.keys(grants[role].$extend).forEach(function (extendedRole) {
    ...
    */
     ...
     */
    extendRole: function (grants, roles, extenderRoles, condition, attributes) {
