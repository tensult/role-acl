...
var utils = {
     ...
     */
    getUnionConditionalAttrsOfRoles: function (grants, query, context) {
        if (!grants) {
        ...
        var roles = utils.getFlatRoles(grants, query.role, context);
        ...
        roles.forEach(function (role, index) {
            ...
            if (grantItem) {
                ...
                if (resource) {
                    ...
                    var actionAttrs = resource[query.action + ':' + query.possession]
