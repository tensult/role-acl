...
var AccessControl = /** @class */ (function () {
    ...
    */
    AccessControl.prototype.allowedGrants = function (role, context) {
     ...
     */
    AccessControl.prototype.allowedActions = function (role, resource, context) {
        return utils_1.default.getUnionActionsOfRoles(this._grants, role, resource, context);
    };
    /**
     ...
     */
    AccessControl.prototype.allowedResources = function (role, context) {
        return utils_1.default.getUnionResourcesOfRoles(this._grants, role, context);
    };
    /**
