...
var AccessControl = /** @class */ (function () {
     ...
     */
    AccessControl.prototype.extendRole = function (roles, extenderRoles, condition, attributes) {
        utils_1.default.extendRole(this._grants, roles, extenderRoles, condition, attributes);
        return this;
    };
    /**
    ...
    */
    AccessControl.prototype.allowedGrants = function (query) {
        return utils_1.default.getUnionGrantsOfRoles(this._grants, query);
    };
    /**
    ...
    AccessControl.prototype.allowedActions = function (query) {
        return utils_1.default.getUnionActionsOfRoles(this._grants, query);
    };
    /**
    ...
    AccessControl.prototype.allowedResources = function (query) {
        return utils_1.default.getUnionResourcesOfRoles(this._grants, query);
    };
    /**
